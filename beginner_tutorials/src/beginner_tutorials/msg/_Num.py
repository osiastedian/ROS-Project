...
class Num(genpy.Message):
  _md5sum = "92f0ffdeffe6b8cddf6eb1e0ce8683b5"
...
"""
  ...
  _slot_types = ['int64','string','string','uint8','uint8']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.age, _x.score))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.age, _x.score,) = _get_struct_2B().unpack(str[start:end])
      return self
