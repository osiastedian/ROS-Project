...
"""autogenerated by genpy from ford_msgs/ImageObj.msg. Do not edit."""
import sys
...
class ImageObj(genpy.Message):
  _md5sum = "c88cbd43b13207de9206c423074bc310"
  _type = "ford_msgs/ImageObj"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','ford_msgs/ImageRect[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.class_string = str[start:end].decode('utf-8')
        else:
          val1.class_string = str[start:end]
        start = end
        end += 4
