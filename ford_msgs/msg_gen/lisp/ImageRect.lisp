...
(cl:defmethod cl:initialize-instance :after ((m <ImageRect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageRect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ford_msgs-msg:<ImageRect> is deprecated: use ford_msgs-msg:ImageRect instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:x-val is deprecated.  Use ford_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:y-val is deprecated.  Use ford_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:height-val is deprecated.  Use ford_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:width-val is deprecated.  Use ford_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:score-val is deprecated.  Use ford_msgs-msg:score instead.")
  (score m))

(cl:ensure-generic-function 'class_string-val :lambda-list '(m))
(cl:defmethod class_string-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:class_string-val is deprecated.  Use ford_msgs-msg:class_string instead.")
  (class_string m))

(cl:ensure-generic-function 'class_id-val :lambda-list '(m))
(cl:defmethod class_id-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:class_id-val is deprecated.  Use ford_msgs-msg:class_id instead.")
  (class_id m))

(cl:ensure-generic-function 'average-val :lambda-list '(m))
(cl:defmethod average-val ((m <ImageRect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:average-val is deprecated.  Use ford_msgs-msg:average instead.")
  (average m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ImageRect>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'average) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageRect>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'average) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ImageRect>)))
  ...
  "7929620497f7b77b0596a67f73028561")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ImageRect)))
  "Returns md5sum for a message object of type 'ImageRect"
  "7929620497f7b77b0596a67f73028561")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ImageRect>)))
  ...
  (cl:format cl:nil "int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%string class_string~%int32 class_id~%std_msgs/ColorRGBA average~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ImageRect)))
  "Returns full string definition for message of type 'ImageRect"
  (cl:format cl:nil "int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%string class_string~%int32 class_id~%std_msgs/ColorRGBA average~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ImageRect>))
  (cl:+ 0
     ...
     4
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'average))
))
