...
(cl:defclass <ImageObj> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj
    :reader obj
    :initarg :obj
    :type (cl:vector ford_msgs-msg:ImageRect)
   :initform (cl:make-array 0 :element-type 'ford_msgs-msg:ImageRect :initial-element (cl:make-instance 'ford_msgs-msg:ImageRect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ImageObj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageObj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ford_msgs-msg:<ImageObj> is deprecated: use ford_msgs-msg:ImageObj instead.")))
...
(cl:defmethod obj-val ((m <ImageObj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ford_msgs-msg:obj-val is deprecated.  Use ford_msgs-msg:obj instead.")
  (obj m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageObj>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ford_msgs-msg:ImageRect))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ImageObj>)))
  ...
  "c88cbd43b13207de9206c423074bc310")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ImageObj)))
  "Returns md5sum for a message object of type 'ImageObj"
  "c88cbd43b13207de9206c423074bc310")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ImageObj>)))
  ...
  (cl:format cl:nil "Header header~%string type~%ImageRect[] obj~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ford_msgs/ImageRect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%string class_string~%int32 class_id~%std_msgs/ColorRGBA average~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ImageObj)))
  "Returns full string definition for message of type 'ImageObj"
  (cl:format cl:nil "Header header~%string type~%ImageRect[] obj~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ford_msgs/ImageRect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%string class_string~%int32 class_id~%std_msgs/ColorRGBA average~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
